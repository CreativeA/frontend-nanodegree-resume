...
var HTMLskillsStart = '<div id="skillbox"><h3 id="skills-h3">Ice Breaker? Let\'s play!</h3><h3 class="subtitle">The Skill Play Pen</h3><h5>Instructions: Drag & drop the skills to order them from cool to red hot >> Go, go, go!</h5><ul id="skills" class="flex-box"></ul></div>';
